...
class LGSyllableComponentsSpec extends FlatSpec {

  "Syllabification of a literary Greek string"  should "preserve leading and trailing content when recursively splitting on diaeresis" in {
